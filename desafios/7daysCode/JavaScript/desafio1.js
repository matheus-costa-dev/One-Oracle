...
function compararElementos(elemento1, elemento2){
    ...
    if (elemento1 == elemento2 ) {
        texto = typeof(elemento1) == typeof(elemento2) ? 'e o mesmo tipo'  :  'mas tipos diferentes' 
        console.log('As variáveis numeroUm e stringUm tem o mesmo valor ' + texto)
    } else {
        console.log('As variáveis numeroUm e stringUm não tem o mesmo valor')
    }
}
...
compararElementos(numeroUm, stringUm)
compararElementos(numeroDez, stringDez)
compararElementos(numeroTrinta, stringTrinta)
