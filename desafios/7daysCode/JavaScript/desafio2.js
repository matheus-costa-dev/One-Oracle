...
console.log(`"Olá ${idade}, você tem ${idade} anos e já está aprendendo ${linguagem}!` );
...
while (gostaEstudar != 1 && gostaEstudar !=2) {
    ...
    if (gostaEstudar == null) {
        break
    }
};

const texto = gostaEstudar == 1 ? " Muito bom! Continue estudando e você terá muito sucesso." : "Ahh que pena... Já tentou aprender outras linguagens?";
